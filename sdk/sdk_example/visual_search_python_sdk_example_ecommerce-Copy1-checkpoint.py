...
fn = choice(glob("../../images/art/resized/*.jpg"))
...
for result in search_results["results"]:
    fn = "../../images/art/resized/{}".format(result["id"])
    img = plt.imread(fn)
    image_labels.append(fn.split("/")[-1])
    images_paths.append(img)    
ipyplot.plot_images(images_paths, labels=image_labels, img_width=200)
# -

choice(glob("../../images/art/resized/*.jpg"))
